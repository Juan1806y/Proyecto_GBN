...
export function ControlPanel({
  ...
  return (
    <div className="space-y-4">
      <Panel title="Panel de control" subtitle="Emisión y ejecución">
        <Button
          variant="primary"
        ...
        <p
          className={cx(
            ...
            blocked ? 'text-rose-300/90' : 'text-slate-500',
          )}
        >
        ...
        <label className="mt-3 flex cursor-pointer items-center justify-between rounded-xl border border-white/10 bg-white/[0.03] px-3 py-2">
