/**
 * Panel del receptor. En Go-Back-N la ventana de recepción tiene siempre apertura 1:
...
export function ReceiverPanel({ state }: { state: SimState }) {
  ...
  return (
    <Panel
      accent="emerald"
      title="3 · Receptor"
      subtitle="Ventana de recepción de apertura 1 · entrega en orden a la capa de red"
      aside={
