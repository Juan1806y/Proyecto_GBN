/**
 * Panel del emisor: búfer de paquetes 0..15, ventana deslizante de apertura N,
...
export function SenderPanel({ state, derived }: { state: SimState; derived: Derived }) {
  ...
  return (
    <Panel
      accent="indigo"
      title="1 · Emisor"
      subtitle="Búfer de la capa de red y ventana de envío (apertura N)"
      aside={
